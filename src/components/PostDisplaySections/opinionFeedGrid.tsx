...
const OpinionFeedGrid = ({opinionFeed}: {opinionFeed: NormalizedPost[]}) => {
  return (
    <div className="flex flex-col lg:flex-row gap-0 w-full items-stretch border-t border-sub">
                  {opinionFeed.map((post, idx) => {
                    ...
                    return (
                      <div className={`relative flex flex-col gap-3 justify-between ${columnStyle}`} key={post.id}>
                        ...
                        <div className="flex flex-col gap-2 pr-12">
                          ...
                          /> */}
                          <Link href={post.postUrl} className="hover:text-accent-main transition-colors">
