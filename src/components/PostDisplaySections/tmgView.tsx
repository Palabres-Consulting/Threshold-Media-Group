...
const TMGView = ({ posts = [], lang, site }: ThresholdOpinionsProps) => {
  ...
  return (
    <section
      ...
      id="tmgView"
    >
      <div className="px-6 pt-20 pb-6 border-b border-sub-side">
        <h2 className="text-[2rem] font-bold font-serif">TMG's View</h2>
      </div>
