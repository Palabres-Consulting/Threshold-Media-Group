  ...
  return (
    <footer className=" overflow-hidden lg:px-16 px-5   bg-foreground/5  ">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:py-16 py-10">
        ...
        <div className="">
          <h3 className="font-semibold text-lg mb-4">PLAN DU SITE</h3>
        ...
        <div className="">
          <h3 className="font-semibold text-lg mb-4">INFOS DE CONTACT</h3>
          <p className="">
      ...
      <div className="py-6 flex flex-col lg:flex-row-reverse lg: justify-between items-center gap-5 border-sub-top text-sm">
        <strong className="">Terms & Conditions | Privacy and Policy</strong>
        <strong className="">All Rights Reserved - Threshold 2025</strong>
      </div>
    </footer>
  );
};
