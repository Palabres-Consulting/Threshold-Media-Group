...
const dictionaries = {
  main: {
    en: () => import("@/lib/locale/main/en.json").then((m) => m.default),
    fr: () => import("@/lib/locale/main/fr.json").then((m) => m.default),
  },
  extraction: {
    en: () =>
      import("@/lib/locale/extraction/en.json").then((m) => m.default),
    fr: () =>
      import("@/lib/locale/extraction/fr.json").then((m) => m.default),
  },
  asint: {
    en: () => import("@/lib/locale/asint/en.json").then((m) => m.default),
    fr: () => import("@/lib/locale/asint/fr.json").then((m) => m.default),
  },
};
