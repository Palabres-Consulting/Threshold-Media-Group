...
const Aboutpage = () => {
  ...
  return (
    <PageContainer id="about" path="" title="About">
      <div className="flex flex-col ">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between mt-4 lg:gap-x-28 gap-10 py-8">
            <div className="lg:w-[45%] border-t-2 border-solid border-accent-main py-8">
              <h4 className="text-[1.5rem] font-semibold">
                ...
                eveniet tempore aut, labore iure nisi.
              </h4>
            </div>
            <div className="lg:w-[50%] flex flex-col gap-5 text-foreground/50">
              <p className="text-[1.2rem]">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Unde,
                rerum illo at laudantium tenetur magnam!
              </p>
              <div className="text-sm gap-5 flex flex-col">
                <p className="">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui
                  quaerat voluptate consequatur est labore obcaecati, dolores
                  eveniet veniam itaque ipsum nisi voluptates voluptatibus
                  commodi asperiores eius. Odio, est! Illum, illo!
                </p>
                <p className="">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Quaerat mollitia cum alias recusandae doloremque. Ex vel quae
                  doloribus rerum aut minima animi, dolor architecto cum illum?
                  Facere sed enim et?
                </p>
              </div>
            </div>
        ...
        <div className="py-10 border-sub-y lg:p-6 p-3" id="team">
          <div className="flex flex-col text-center mb-14">
            <h2 className="text-[3rem] font-bold mb-6">Notre equipe</h2>
            <p className="text-foreground/50">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit
              laboriosam expedita facilis
            </p>
          </div>
        ...
        <div className="py-10 border-sub-y lg:p-6 p-3" id="service">
          <div className="flex flex-col text-center mb-14">
            <h2 className="text-[3rem] font-bold mb-6">Services</h2>
            <p className="text-foreground/50">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit
              laboriosam expedita facilis
            </p>
        ...
        <div className="lg:px-6 px-3 py-10 " id="process">
          <div className="flex flex-col text-center mb-14">
            <h2 className="text-[3rem] font-bold mb-6">Processes</h2>
            <p className="text-foreground/50">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit
              laboriosam expedita facilis
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-center items-center w-full">
            ...
            <div className="lg:w-[30%] flex flex-col">
              ...
              <p className="text-sm">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit
                odit ipsa magnam fugit a quasi saepe provident! Vero beatae
                aliquam obcaecati, a assumenda esse sapiente minus natus dolor?
                Perferendis, quo! aliquam obcaecati, a assumenda esse sapiente
                minus natus dolor? Perferendis, quo!
              </p>
            </div>
          </div>
        </div>
