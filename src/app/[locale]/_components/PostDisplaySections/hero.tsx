      ...
      <div className="flex flex-col lg:h-[85vh] lg:flex-row lg:p-5 p-3 gap-8">
        ...
        {post1 && (
          <div className="lg:w-[70%] rounded-2xl relative overflow-hidden h-[70vh] lg:h-full">
            <Link
              href={`/journal/${data?.[0]?.slug || ""}?id=${data?.[0]?.id || ""}&type=${site}`}
            >
              ...
              <div className="absolute bottom-0 left-0 p-8 flex flex-col gap-3 z-50">
                <CategoryTime
                  category={topCategory1.name || "Uncategorized"}
        ...
        <div className="lg:w-[30%] w-full h-full flex flex-col gap-5">
          ...
          {post2 && (
            <Link
              href={`/journal/${data?.[1]?.slug || ""}?type=${site}`}
            ...
            >
              ...
              <div className="lg:h-[25%] flex flex-col gap-3">
                <CategoryTime
                  category={topCategory2.name || "Uncategorized"}
                  readTime="10 mins read"
                  back={false}
                  bg={true}
                />
          ...
          {post3 && (
            <Link
              href={`/journal/${data?.[2]?.slug || ""}?type=${site}`}
            ...
            >
              ...
              <div className="w-[60%] h-full">
                <div className="flex flex-col gap-2">
                  <CategoryTime
                    category={topCategory3.name || "Uncategorized"}
                    readTime="10 mins read"
                    back={false}
                    bg={true}
                  />
