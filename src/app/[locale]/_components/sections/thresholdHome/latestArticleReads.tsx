...
const LatestArticleReads = () => {
  ...
  return (
    <section className="lg:p-6 px-3 py-12 flex flex-col lg:flex-row gap-4">
      ...
      <div className=" lg:h-[115vh] rounded-2xl lg:w-[30%] lg:p-6  flex flex-col gap-10 bg-foreground/5">
        <div className="rounded-2xl h-[30%] relative flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="h-[70%] min-[60vh] rounded-2xl bg-stone-700">
          {/* MAP */}
        </div>
      </div>
    </section>
...
export default LatestArticleReads;
