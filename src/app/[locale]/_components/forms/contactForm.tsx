      ...
      <div className="">
        <div className="flex gap-3">
          <div className="flex flex-col gap-2 w-full">
            <label>{dict.contact.contactForm.fullName.firstNameLabel}</label>
            <input
              type="text"
              placeholder={
                dict.contact.contactForm.fullName.firstNamePlaceholder
              }
              className="input"
            />
          </div>
          <div className="flex flex-col gap-2 w-full">
            <label>{dict.contact.contactForm.fullName.lastNameLabel}</label>
            <input
              type="text"
              placeholder={
                dict.contact.contactForm.fullName.lastNamePlaceholder
              }
              className="input"
            />
          </div>
